...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.course'
        db.add_column(u'course_forum', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['course.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.course'
        db.delete_column(u'course_forum', 'course_id')
