...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LikertAttempt.correct'
        db.add_column(u'quiz_likertattempt', 'correct',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LikertAttempt.correct'
        db.delete_column(u'quiz_likertattempt', 'correct')
