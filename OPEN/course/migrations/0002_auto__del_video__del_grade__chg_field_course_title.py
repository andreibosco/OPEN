...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'course_course', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Course.title'
        db.alter_column(u'course_course', 'title', self.gf('django.db.models.fields.CharField')(max_length=30))
