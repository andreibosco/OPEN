...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UploadedFile.file_type'
        db.add_column(u'course_uploadedfile', 'file_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UploadedFile.file_type'
        db.delete_column(u'course_uploadedfile', 'file_type')
    ...
    models = {
        ...
        u'course.uploadedfile': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'file_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
