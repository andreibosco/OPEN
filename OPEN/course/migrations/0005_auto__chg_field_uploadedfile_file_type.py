...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadedFile.file_type'
        db.alter_column(u'course_uploadedfile', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'UploadedFile.file_type'
        db.alter_column(u'course_uploadedfile', 'file_type', self.gf('django.db.models.fields.CharField')(max_length=2))
