...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Forum.uploads'
        db.add_column(u'course_forum', 'uploads',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='3', to=orm['course.UploadedFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Forum.uploads'
        db.delete_column(u'course_forum', 'uploads_id')
